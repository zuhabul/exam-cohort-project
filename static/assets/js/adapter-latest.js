    ...
    })()(
        {
                    ...
                    function adapterFactory() {
                        ...
                        switch (browserDetails.browser) {
                            case "chrome":
                                ...
                                commonShim.removeExtmapAllowMixed(
                                    window,
                                    browserDetails
                                );
                                break;
            ...
            3: [
                function (require, module, exports) {
                    ...
                    exports.shimGetDisplayMedia = exports.shimGetUserMedia =
                        undefined;
                    ...
                    exports.shimSenderReceiverGetStats =
                        ...
                        if (
                            ...
                            window.RTCPeerConnection.prototype.setRemoteDescription =
                                function setRemoteDescription() {
                                    ...
                                    return origSetRemoteDescription.apply(
                                        this,
                                        arguments
                                    );
                                };
                    ...
                    function shimGetSendersWithDtmf(window) {
                        ...
                        if (
                            ...
                            var shimSenderWithDtmf =
                                function shimSenderWithDtmf(pc, track) {
                                    return {
                                        track: track,
                                        get dtmf() {
                            ...
                            if (
                                ...
                                window.RTCPeerConnection.prototype.addTrack =
                                    function addTrack(track, stream) {
                                        var sender = origAddTrack.apply(
                                            this,
                                            arguments
                                        );
                                        if (!sender) {
                                            sender = shimSenderWithDtmf(
                                                this,
                                                track
                                            );
                            ...
                            window.RTCPeerConnection.prototype.getSenders =
                                function getSenders() {
                                    ...
                                    var senders = origGetSenders.apply(
                                        this,
                                        []
                                    );
                    ...
                    function shimGetStats(window) {
                        ...
                        window.RTCPeerConnection.prototype.getStats =
                            function getStats() {
                                ...
                                var fixChromeStats_ = function fixChromeStats_(
                                    response
                                ) {
                                    var standardReport = {};
                                    ...
                                    reports.forEach(function (report) {
                                        ...
                                        standardReport[standardStats.id] =
                                            standardStats;
                                    });
                                ...
                                var makeMapStats = function makeMapStats(
                                    stats
                                ) {
                                    return new Map(
                                ...
                                if (arguments.length >= 2) {
                                    var successCallbackWrapper_ =
                                        function successCallbackWrapper_(
                                            response
                                        ) {
                                            onSucc(
                                                makeMapStats(
                    ...
                    function shimSenderReceiverGetStats(window) {
                        ...
                        if (!("getStats" in window.RTCRtpSender.prototype)) {
                            ...
                            window.RTCRtpSender.prototype.getStats =
                                function getStats() {
                                    var sender = this;
                                    return this._pc
                                        .getStats()
                            ...
                            if (origGetReceivers) {
                                window.RTCPeerConnection.prototype.getReceivers =
                                    function getReceivers() {
                                        ...
                                        var receivers = origGetReceivers.apply(
                                            this,
                                            []
                                        );
                        ...
                        window.RTCPeerConnection.prototype.getLocalStreams =
                            function getLocalStreams() {
                                ...
                                return Object.keys(
                                    ...
                                    return _this8
                                        ._shimmedLocalStreams[streamId][0];
                                });
                            };
                        ...
                        window.RTCPeerConnection.prototype.addTrack =
                            function addTrack(track, stream) {
                                ...
                                if (!this._shimmedLocalStreams[stream.id]) {
                                    ...
                                    this._shimmedLocalStreams[stream.id].push(
                                        sender
                                    );
                                }
                                return sender;
                                ...
                                if (sender) {
                                    Object.keys(
                                        ...
                                        if (
                                            ...
                                            delete _this10._shimmedLocalStreams[
                                                streamId
                                            ];
                                        }
                                    });
                    ...
                    function shimAddTrackRemoveTrack(window, browserDetails) {
                        ...
                        window.RTCPeerConnection.prototype.getLocalStreams =
                            function getLocalStreams() {
                                ...
                                var nativeStreams =
                                    origGetLocalStreams.apply(this);
                        ...
                        window.RTCPeerConnection.prototype.addTrack =
                            function addTrack(track, stream) {
                                ...
                                var alreadyExists = this.getSenders().find(
                                    function (s) {
                                        return s.track === track;
                                    }
                                );
                        ...
                        window.RTCPeerConnection.prototype.setLocalDescription =
                            function setLocalDescription() {
                                if (!arguments.length || !arguments[0].type) {
                                    return origSetLocalDescription.apply(
                                        this,
                                        arguments
                                    );
                                }
                        ...
                        Object.defineProperty(
                            ...
                            "localDescription",
                            {
                                get: function get() {
                                    var description =
                                        origLocalDescription.get.apply(this);
                                    if (description.type === "") {
                                        return description;
                                    }
                                    return replaceInternalStreamId(
                        ...
                        window.RTCPeerConnection.prototype.removeTrack =
                            function removeTrack(sender) {
                                ...
                                this._streams = this._streams || {};
                                var stream = void 0;
                                Object.keys(this._streams).forEach(function (
                                    streamid
                                ) {
                        ...
                        utils.wrapPeerConnectionEvent(
                            ...
                            function (e) {
                                ...
                                if (
                                    ...
                                    (pc.getConfiguration &&
                                        pc.getConfiguration().sdpSemantics ===
                                            "plan-b")
                                ) {
            ...
            5: [
                function (require, module, exports) {
                    ...
                    function shimGetUserMedia(window, browserDetails) {
                        ...
                        var constraintsToChrome_ =
                            function constraintsToChrome_(c) {
                                if (
                                    (typeof c === "undefined"
                                        ? "undefined"
                                        : _typeof(c)) !== "object" ||
                                ...
                                Object.keys(c).forEach(function (key) {
                                    ...
                                    var oldname_ = function oldname_(
                                        prefix,
                                        name
                                    ) {
                                        if (prefix) {
                        ...
                        var shimConstraints_ = function shimConstraints_(
                            ...
                            if (
                                constraints &&
                                _typeof(constraints.audio) === "object"
                            ) {
                            ...
                            if (
                                constraints &&
                                _typeof(constraints.video) === "object"
                            ) {
            ...
            6: [
                function (require, module, exports) {
                    ...
                    function shimRTCIceCandidate(window) {
                        ...
                        window.RTCIceCandidate = function RTCIceCandidate(
                            args
                        ) {
                            ...
                            if (args.candidate && args.candidate.length) {
                                ...
                                var nativeCandidate = new NativeRTCIceCandidate(
                                    args
                                );
                                var parsedCandidate =
                                    _sdp2.default.parseCandidate(
                                        args.candidate
                                    );
                                ...
                                augmentedCandidate.toJSON = function toJSON() {
                                    return {
                                        ...
                                        sdpMLineIndex:
                                            augmentedCandidate.sdpMLineIndex,
                                        usernameFragment:
                    ...
                    function shimMaxMessageSize(window, browserDetails) {
                        ...
                        var sctpInDescription = function sctpInDescription(
                            description
                        ) {
                            if (!description || !description.sdp) {
                                return false;
                            }
                            var sections = _sdp2.default.splitSections(
                                description.sdp
                            );
                            sections.shift();
                            return sections.some(function (mediaSection) {
                                var mLine =
                                    _sdp2.default.parseMLine(mediaSection);
                                return (
                                    mLine &&
                        ...
                        var getRemoteFirefoxVersion =
                            function getRemoteFirefoxVersion(description) {
                        ...
                        var getCanSendMaxMessageSize =
                            function getCanSendMaxMessageSize(remoteIsFirefox) {
                        ...
                        window.RTCPeerConnection.prototype.setRemoteDescription =
                            function setRemoteDescription() {
                                ...
                                if (
                                    ...
                                    var _getConfiguration =
                                            this.getConfiguration(),
                                        sdpSemantics =
                                            _getConfiguration.sdpSemantics;

                                    if (sdpSemantics === "plan-b") {
                                        Object.defineProperty(this, "sctp", {
                                            get: function get() {
                                                return typeof this._sctp ===
                                                    "undefined"
                                                    ? null
                                                    : this._sctp;
                                            },
                                ...
                                if (sctpInDescription(arguments[0])) {
                                    ...
                                    var isFirefox = getRemoteFirefoxVersion(
                                        arguments[0]
                                    );

                                    // Get the maximum message size the local peer is capable of sending
                                    var canSendMMS =
                                        getCanSendMaxMessageSize(isFirefox);

                                    // Get the maximum message size of the remote peer.
                                    var remoteMMS = getMaxMessageSize(
                                        arguments[0],
                                        isFirefox
                                    );
                    ...
                    function shimSendThrowTypeError(window) {
                        ...
                        function wrapDcSend(dc, pc) {
                            ...
                            dc.send = function send() {
                                ...
                                var length =
                                    data.length || data.size || data.byteLength;
                                if (
                                    dc.readyState === "open" &&
                                    pc.sctp &&
                        ...
                        window.RTCPeerConnection.prototype.createDataChannel =
                            function createDataChannel() {
                                var dataChannel = origCreateDataChannel.apply(
                                    this,
                                    arguments
                                );
                    ...
                    function shimAddIceCandidateNullOrEmpty(
                        window,
                        browserDetails
                    ) {
                        ...
                        if (
                            ...
                            nativeAddIceCandidate.length === 0
                        ) {
                            return;
                        }
                        window.RTCPeerConnection.prototype.addIceCandidate =
                            function addIceCandidate() {
                                ...
                                return nativeAddIceCandidate.apply(
                                    this,
                                    arguments
                                );
                            };
            ...
            7: [
                function (require, module, exports) {
                            ...
                            window.RTCPeerConnection.prototype.addTransceiver =
                                function addTransceiver() {
                                    ...
                                    if (shouldPerformCheck) {
                                        ...
                                        initParameters.sendEncodings.forEach(
                                            function (encodingParam) {
                                                ...
                                                if (
                                                    ...
                                                    if (
                                                        !(
                                                            parseFloat(
                                                                encodingParam.scaleResolutionDownBy
                                                            ) >= 1.0
                                                        )
                                                    ) {
                                    ...
                                    var transceiver = origAddTransceiver.apply(
                                        this,
                                        arguments
                                    );
                                    if (shouldPerformCheck) {
                                        ...
                                        if (
                                            ...
                                            (params.encodings.length === 1 &&
                                                Object.keys(params.encodings[0])
                                                    .length === 0)
                                        ) {
                                            params.encodings =
                                                initParameters.sendEncodings;
                    ...
                    function shimGetParameters(window) {
                        ...
                        var origGetParameters =
                            window.RTCRtpSender.prototype.getParameters;
                        if (origGetParameters) {
                            window.RTCRtpSender.prototype.getParameters =
                                function getParameters() {
                                    var params = origGetParameters.apply(
                                        this,
                                        arguments
                                    );
                                    if (!("encodings" in params)) {
                                        params.encodings = [].concat(
                                            this.sendEncodings || [{}]
                                        );
                                    }
                                    return params;
                ...
                function (require, module, exports) {
                    ...
                    function shimGetUserMedia(window, browserDetails) {
                        ...
                        var MediaStreamTrack =
                            window && window.MediaStreamTrack;
                        ...
                        if (
                            ...
                            if (
                                ...
                                MediaStreamTrack.prototype.getSettings =
                                    function () {
                                        var obj = nativeGetSettings.apply(
                                            this,
                                            arguments
                                        );
                                        remap(
                            ...
                            if (
                                ...
                                MediaStreamTrack.prototype.applyConstraints =
                                    function (c) {
                                        ...
                                        return nativeApplyConstraints.apply(
                                            this,
                                            [c]
                                        );
                                    };
            ...
            10: [
                function (require, module, exports) {
                    ...
                    exports.shimTrackEventTransceiver =
                                    ...
                                    if (streams) {
                                        streams.forEach(function (stream) {
                                            if (!_this2._localStreams) {
                                                ...
                                                !_this2._localStreams.includes(
                                                    stream
                                                )
                                            ) {
                                                _this2._localStreams.push(
                                                    stream
                                                );
                                            }
                                        });
                        ...
                        if (
                            ...
                            window.RTCPeerConnection.prototype.removeStream =
                                function removeStream(stream) {
                                    ...
                                    var index =
                                        this._localStreams.indexOf(stream);
                                    if (index === -1) {
                                        return;
                                    }
                                        ...
                                        this.addEventListener(
                                            ...
                                            (this._onaddstreampoly = function (
                                                ...
                                                e.streams.forEach(function (
                                                    ...
                                                    if (
                                                        _this4._remoteStreams.includes(
                                                            stream
                                                        )
                                                    ) {
                                                        return;
                                                    }
                                                    _this4._remoteStreams.push(
                                                        stream
                                                    );
                                                    var event = new Event(
                                                        "addstream"
                                        ...
                                        this.addEventListener(
                                            ...
                                            (this._onaddstreampoly = function (
                                                ...
                                                e.streams.forEach(function (
                                                    ...
                                                    if (
                                                        pc._remoteStreams.indexOf(
                                                            stream
                                                        ) >= 0
                                                    ) {
                                                        return;
                                                    }
                                                    pc._remoteStreams.push(
                                                        stream
                                                    );
                                                    var event = new Event(
                                                        "addstream"
                    ...
                    function shimCreateOfferLegacy(window) {
                        ...
                        window.RTCPeerConnection.prototype.createOffer =
                            function createOffer(offerOptions) {
                                if (offerOptions) {
                                    if (
                                        typeof offerOptions.offerToReceiveAudio !==
                                        "undefined"
                                    ) {
                                        // support bit values
                                    ...
                                    var audioTransceiver =
                                        this.getTransceivers().find(function (
                                            transceiver
                                        ) {
                                            return (
                                    ...
                                    if (
                                        typeof offerOptions.offerToReceiveVideo !==
                                        "undefined"
                                    ) {
                                        // support bit values
                ...
                function (require, module, exports) {
                    ...
                    function wrapPeerConnectionEvent(
                        ...
                        proto.addEventListener = function (
                            ...
                            this._eventMap[eventNameToWrap].set(
                                cb,
                                wrappedCallback
                            );
                        ...
                        proto.removeEventListener = function (
                            ...
                            var unwrappedCb =
                                this._eventMap[eventNameToWrap].get(cb);
                    ...
                    function compactObject(data) {
                        ...
                        return Object.keys(data).reduce(function (
                            ...
                            var value = isObj
                                ? compactObject(data[key])
                                : data[key];
                            var isEmptyObject =
                                isObj && !Object.keys(value).length;
            ...
            12: [
                function (require, module, exports) {
                    ...
                    SDPUtils.matchPrefix = function (blob, prefix) {
                        return SDPUtils.splitLines(blob).filter(function (
                            line
                        ) {
                        ...
                        for (var i = 8; i < parts.length; i += 2) {
                            switch (parts[i]) {
                                case "raddr":
                                    ...
                                    break;
                                case "rport":
                                    candidate.relatedPort = parseInt(
                                        parts[i + 1],
                                        10
                                    );
                                    break;
                    ...
                    SDPUtils.writeFmtp = function (codec) {
                        ...
                        if (
                            ...
                            var params = [];
                            Object.keys(codec.parameters).forEach(function (
                                param
                            ) {
                                if (codec.parameters[param]) {
                                    params.push(
                                        param + "=" + codec.parameters[param]
                                    );
                                } else {
                                    params.push(param);
                                }
                    ...
                    SDPUtils.writeDtlsParameters = function (
                        params,
                        setupType
                    ) {
                    ...
                    SDPUtils.getCryptoParameters = function (
                        mediaSection,
                        sessionpart
                    ) {
                        var lines = SDPUtils.matchPrefix(
                    ...
                    SDPUtils.writeRtpDescription = function (kind, caps) {
                        ...
                        sdp +=
                            caps.codecs
                                .map(function (codec) {
                                    if (
                                        codec.preferredPayloadType !== undefined
                                    ) {
                    ...
                    SDPUtils.parseRtpEncodingParameters = function (
                        ...
                        var hasRed =
                            description.fecMechanisms.indexOf("RED") !== -1;
                        var hasUlpfec =
                            description.fecMechanisms.indexOf("ULPFEC") !== -1;

                        // filter a=ssrc:... cname:, ignore PlanB-msid
                        var ssrcs = SDPUtils.matchPrefix(
                            mediaSection,
                            "a=ssrc:"
                        )
                            .map(function (line) {
                        ...
                        var bandwidth = SDPUtils.matchPrefix(
                            mediaSection,
                            "b="
                        );
                        if (bandwidth.length) {
                    ...
                    SDPUtils.parseMsid = function (mediaSection) {
                        ...
                        var planB = SDPUtils.matchPrefix(
                            mediaSection,
                            "a=ssrc:"
                        )
                            .map(function (line) {
                    ...
                    SDPUtils.parseSctpDescription = function (mediaSection) {
                        ...
                        var sctpPort = SDPUtils.matchPrefix(
                            mediaSection,
                            "a=sctp-port:"
                        );
                        ...
                        var sctpMapLines = SDPUtils.matchPrefix(
                            mediaSection,
                            "a=sctpmap:"
                        );
                    ...
                    SDPUtils.getDirection = function (
                        mediaSection,
                        sessionpart
                    ) {
